                ...
                if mistake[0] == verbs_list[i][0]:
                    ...
                    if phrase == phrase_verb:
                        ...
                        if len(line_out) == 6:
                            line_out.append(lemma)  # в строку из файла mistakes.tsv добавляются столбцы с морф.разбором
                            line_out.append(grammar)
                            out_v.append(line_out) # print(line_out)
